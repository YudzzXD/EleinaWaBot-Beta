...
const isOwner = [`${setting.ownerNumber}`,"6285840104297@s.whatsapp.net","6285840104297@s.whatsapp.net"].includes(sender) ? true : false
...
const gurbot = '6287748217883@s.whatsapp.net'
...
var bg_aliga = '6285840104297@s.whatsapp.net'
...
var opt = { packname: 'WhatsApp Bot', author: 'By WhatsApp LLC' }
...
var dev = '6285840104297@s.whatsapp.net'
...
case 'ai': case 'openai': 
          try {
            if (setkey.keyopenai === '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') return reply('Apikey belum diisi\n\nSilahkan isi terlebih dahulu apikeynya di file key.json\n\nApikeynya bisa dibuat di website: https://beta.openai.com/account/api-keys');
            if (!q) return reply(`Chat dengan AI.\n\nContoh:\n${prefix}${command} Apa itu resensi`);
